...
export const FETCH_USERS_URL = `${API_ROOT}/users/`;
...
export const NOTE_DETAIL_URL = (slug: string): string =>
  `${API_ROOT}/note/${slug}/`;
export const SHARE_NOTE_WITH_USER_URL = (slug: string): string =>
  `${API_ROOT}/note/${slug}/add_user/`;
export const REMOVE_NOTE_VIEWSER_URL = (slug: string): string =>
  `${API_ROOT}/note/${slug}/remove_user/`;
